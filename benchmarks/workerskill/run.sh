...
if [[ $all -eq 1 ]]; then
        ...
        $bmscripts/runinsts.sh "./*.hex" "$mydir/run.sh" "$mydir" "$to"                             # (1)
        ...
        # run single instance
        confstr="--eaevalheuristics=always --cspanticipatelearning=true --cspgraphlearning=true --csplearning=none;--eaevalheuristics=always --cspanticipatelearning=true --cspgraphlearning=true --csplearning=deletion;--eaevalheuristics=always --cspanticipatelearning=true --cspgraphlearning=true --csplearning=forward;--eaevalheuristics=always --cspanticipatelearning=true --cspgraphlearning=true --csplearning=jumpforward;--eaevalheuristics=always --cspanticipatelearning=true --cspgraphlearning=true --csplearning=backward;--eaevalheuristics=always --cspanticipatelearning=true --cspgraphlearning=true --csplearning=range;--eaevalheuristics=always --cspanticipatelearning=true --cspgraphlearning=true --csplearning=cc;--eaevalheuristics=always --cspanticipatelearning=true --cspgraphlearning=true --csplearning=wcc;--eaevalheuristics=always --cspanticipatelearning=true --csplearning=none;--eaevalheuristics=always --cspanticipatelearning=true --csplearning=deletion;--eaevalheuristics=always --cspanticipatelearning=true --csplearning=forward;--eaevalheuristics=always --cspanticipatelearning=true --csplearning=jumpforward;--eaevalheuristics=always --cspanticipatelearning=true --csplearning=backward;--eaevalheuristics=always --cspanticipatelearning=true --csplearning=range;--eaevalheuristics=always --cspanticipatelearning=true --csplearning=cc;--eaevalheuristics=always --cspanticipatelearning=true --csplearning=wcc;--eaevalheuristics=never --csplearning=none;--eaevalheuristics=never --csplearning=deletion;--eaevalheuristics=never --csplearning=forward;--eaevalheuristics=never --csplearning=jumpforward;--eaevalheuristics=never --csplearning=backward;--eaevalheuristics=never --csplearning=range;--eaevalheuristics=never --csplearning=cc;--eaevalheuristics=never --csplearning=wcc"                                                                    # (2)
        $bmscripts/runconfigs.sh "dlvhex2nooutput -n=1 --cspenable INST CONF" "$confstr" "$instance" "$to"  "memouttimeoutputbuilder.sh"  # (3)
